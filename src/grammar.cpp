...
void demo_lambda() {
    ...
    int y = 20;
    auto printY = [&y]() {
        cout << "Captured by reference, y = " << y << endl;
    };
    y = 30;
    ...
    int a = 10, b = 20;
    auto printAB = [=, &b]() {
        cout << "Captured by value, a = " << a << ", Captured by reference, b = " << b << endl;
    };
    a = 30;
    b = 40;
    printAB(); // Output: Captured by value, a = 10, Captured by reference, b = 40
