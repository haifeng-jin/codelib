...
void demo_upper_bound() {
  ...
  cout << "Upper bound of 50 is at index: " << distance(vec.begin(), ub)
       << endl;
}
...
void demo_find_if() {
  ...
  auto is_greater_than_25 = [](int x) { return x > 25; };
...
void demo_remove_if() {
  ...
  // Use std::remove_if reorders the values to be deleted to the end of the
  // vector. It returns the iterator pointing to the beginning of the elements
  // to be removed. followed by erase to remove the "removed" elements
